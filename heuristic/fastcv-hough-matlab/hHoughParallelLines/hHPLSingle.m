function [imagePoints] = hHPLSingle( image, flagPlot )
%HHPL given the image it tries to extract the four corner points of the
...
imagePoints = getPointsPar(candLines);
