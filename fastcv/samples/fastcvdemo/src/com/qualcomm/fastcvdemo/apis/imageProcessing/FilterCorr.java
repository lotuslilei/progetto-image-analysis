...
public class FilterCorr extends GraphicalActivity {
    ...
    public static final int NINExNINE = 2;
    public static final int ELEVENxELEVEN = 3;
    public static final int THIRTEENxTHIRTEEN = 4;
    public static final int FIFTEENxFIFTEEN = 5;
    public static final int SEVENTEENxSEVENTEEN = 6;
    ...
    {         
        ...
        switch( item.getItemId() ) 
        {
            case R.id.THREExTHREE:
                ...
                return true;
            case R.id.NINExNINE:
            	mKernelType = NINExNINE;
            	mText[2].setText (String.format( "9x9 is selected" ));
            	setKernelType(mKernelType);
                return true;
            case R.id.ELEVENxELEVEN:
            	mKernelType = ELEVENxELEVEN;
            	mText[2].setText (String.format( "11x11 is selected" ));
            	setKernelType(mKernelType);
                return true;
            case R.id.THIRTEENxTHIRTEEN:
            	...
            	setKernelType(mKernelType);
                return true;
            case R.id.FIFTEENxFIFTEEN:
            	mKernelType = FIFTEENxFIFTEEN;
            	mText[2].setText (String.format( "15x15 is selected" ));
            	setKernelType(mKernelType);
                return true;
            case R.id.SEVENTEENxSEVENTEEN:
            	mKernelType = SEVENTEENxSEVENTEEN;
            	mText[2].setText (String.format( "17x17 is selected" ));
            	setKernelType(mKernelType);
                return true;
            case R.id.RESET:
            	mKernelType = RESET;
